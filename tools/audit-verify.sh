...
verify_tag() {
  ...
  elif [[ "$tag" == experiment-0-and-2 || "$tag" == competitive-scorecard || "$tag" == project-meta || "$tag" == cheapcode-v2-surgical-architecture || "$tag" == cheapcode-research-equivalence-computation ]]; then
